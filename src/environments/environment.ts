...
export const environment = {
  ...
  imgUrl: 'https://localhost:7268/',
  portalUrl: 'https://localhost:7268/',
  frontendUrl: 'http://localhost:4200/',

  //Staging
  // apiUrl: 'http://test.prophero.net/api/',
  // imgUrl: 'http://test.prophero.net/api/',
  // portalUrl: 'http://test.prophero.net/api/',
  // frontendUrl: 'http://test.prophero.net/',

  // //Production

  // apiUrl: 'https://crm.prophero.net/api/',
  // imgUrl: 'https://crm.prophero.net/api/',
  // portalUrl: 'https://crm.prophero.net/api/',
  // frontendUrl: 'https://crm.prophero.net/',
